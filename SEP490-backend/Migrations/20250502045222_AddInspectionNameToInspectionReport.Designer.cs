...
namespace Sep490_Backend.Migrations
{
    ...
    [Migration("20250502045222_AddInspectionNameToInspectionReport")]
    partial class AddInspectionNameToInspectionReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sep490_Backend.Infra.Entities.InspectionReport", b =>
                {
                    ...
                    b.Property<int>("ConstructionProgressItemId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ConstructionProgressItemId");
            ...
            modelBuilder.Entity("Sep490_Backend.Infra.Entities.PlanEditLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PlanEditLocks", (string)null);
                });
            ...
            modelBuilder.Entity("Sep490_Backend.Infra.Entities.InspectionReport", b =>
                {
                    b.HasOne("Sep490_Backend.Infra.Entities.ConstructionProgressItem", "ConstructionProgressItem")
                        .WithMany()
                        .HasForeignKey("ConstructionProgressItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("ConstructionProgressItem");
            ...
            modelBuilder.Entity("Sep490_Backend.Infra.Entities.SiteSurvey", b =>
                {
                    b.HasOne("Sep490_Backend.Infra.Entities.User", "Conductor")
