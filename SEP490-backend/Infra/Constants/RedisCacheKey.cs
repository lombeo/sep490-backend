namespace Sep490_Backend.Infra.Constants
{
    public class RedisCacheKey
    {
        ...
        public const string RESOURCE_ALLOCATION_REQ_BY_ID_CACHE_KEY = "RESOURCE_ALLOCATION_REQ_DETAIL:{0}"; // Pattern: RESOURCE_ALLOCATION_REQ_DETAIL:reqId
        public const string RESOURCE_MOBILIZATION_REQ_BY_ID_CACHE_KEY = "RESOURCE_MOBILIZATION_REQ_DETAIL:{0}"; // Pattern: RESOURCE_MOBILIZATION_REQ_DETAIL:reqId
